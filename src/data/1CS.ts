...
const thirdYearCurriculum: Curriculum = {
  ...
  semester1Link:
    "https://drive.google.com/drive/folders/1KTqkXaOH4EOmVjwpunFSMDU20qwP-VYU?usp=drive_link",
  semester2Link:
    "https://drive.google.com/drive/folders/1S3GxoJqKCqydOHwtBlGTOQ7ftSFDubqC?usp=drive_link",
  semester1: [
    {
...
export default thirdYearCurriculum;
